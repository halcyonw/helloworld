...
public abstract class RedPacketFrame extends JFrame {
    ...
    private static int money = 0; // 单位为 "分"
    private static int count = 0;

    private static HashMap<JPanel, JLabel> panel_lable = new HashMap<JPanel, JLabel>();
    // 设置字体
    private static Font font_yahei = new Font(null, Font.BOLD, 20);
    private static Font msg_font = new Font("null", Font.BOLD, 20);
    private static Font total_show_font = new Font("null", Font.BOLD, 40);
    private static Font name_font = new Font("null", Font.BOLD, 40);
    private static Font showName_font = new Font("null", Font.BOLD, 20);
    private static Font showMoney_font = new Font("null", Font.BOLD, 50);
    private static Font showResult_font = new Font("null", Font.BOLD, 15);
    ...
    private static JTextField show_result = new JTextField(count + "个红包共" + (money / 100.0) + "元,被抢光了");
    static {
        // 分别设置水平和垂直滚动条自动出现
    ...
    private void addListener() {
        ...
        input_inMoney.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    // 获取页面的值.
                    money = (int) (Double.parseDouble(input_total.getText()) * 100); // 转换成"分"
                    ...
                    System.out.println("总金额: " + money + " 分");
        ...
        open_label.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (openWay == null) {
                    JOptionPane.showMessageDialog(null, "请通过【setOpenMode】方法设置打开方式", "打开方式未设置",
                            JOptionPane.QUESTION_MESSAGE);
                    return;
                }
                ...
                moneyList = openWay.getRedPacket(money, count);
    ...
    public void setOpenMode(OpenMode openWay) {
